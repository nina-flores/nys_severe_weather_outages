...
outages_u_defined <- read.fst("sw_outages_u_defined.fst") %>%
  select(datetime_eastern,dps_id, 
         cold_driven_outage,
...
run <- list("u", "r", "n")
yr <- list(2017,2018,2019,2020)

for(i in run){
  for(j in yr){
    
  
  assign(paste0("sw_outages_",i,"_any_",j), get(paste0("outages_",i,"_defined"))%>%
           filter(year(datetime_eastern) == j) %>%
           group_by(dps_id) %>%
...
write.fst(sw_outages_u_any_2017, "sw_outages_u_any_2017.fst")
write.fst(sw_outages_u_any_2018, "sw_outages_u_any_2018.fst")
write.fst(sw_outages_u_any_2019, "sw_outages_u_any_2019.fst")
write.fst(sw_outages_u_any_2020, "sw_outages_u_any_2020.fst")

write.fst(sw_outages_r_any_2017, "sw_outages_r_any_2017.fst")
write.fst(sw_outages_r_any_2018, "sw_outages_r_any_2018.fst")
write.fst(sw_outages_r_any_2019, "sw_outages_r_any_2019.fst")
write.fst(sw_outages_r_any_2020, "sw_outages_r_any_2020.fst")

write.fst(sw_outages_n_any_2017, "sw_outages_n_any_2017.fst")
write.fst(sw_outages_n_any_2018, "sw_outages_n_any_2018.fst")
write.fst(sw_outages_n_any_2019, "sw_outages_n_any_2019.fst")
write.fst(sw_outages_n_any_2020, "sw_outages_n_any_2020.fst")
